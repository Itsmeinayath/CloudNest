...
export default function DashboardPreview() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      {/* Dashboard Header */}
      <div className="bg-gradient-to-r from-gray-800/80 to-gray-900/80 rounded-t-2xl border border-gray-700/50 border-b-0 p-6 backdrop-blur-sm">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-white mb-2">My Files</h2>
            <p className="text-gray-400">Manage and organize your cloud storage</p>
          </div>
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input 
                ...
                className="bg-gray-800/50 border border-gray-600/50 rounded-lg pl-10 pr-4 py-2 text-sm text-white placeholder-gray-400 focus:border-purple-500/50 transition-colors w-64"
              />
            </div>
      ...
      <div className="bg-gray-800/40 rounded-b-2xl border border-gray-700/50 border-t-0 backdrop-blur-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700/30">
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-400">6 items</span>
