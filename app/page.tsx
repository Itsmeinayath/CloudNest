...
const FeatureCard = ({
  ...
  <motion.div
    ...
    viewport={{ once: true }}
    className="relative p-8 bg-gradient-to-br from-gray-800/80 to-gray-900/90 border border-gray-700/50 rounded-2xl shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 transform hover:-translate-y-2 group backdrop-blur-sm"
  >
    ...
    <div className="relative z-10">
      <div className="flex items-center justify-center w-16 h-16 mb-6 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-2xl border border-purple-500/30 group-hover:scale-110 transition-transform duration-500 group-hover:rotate-3">
        {icon}
      </div>
      <h3 className="text-xl font-bold text-white mb-3 group-hover:text-purple-300 transition-colors duration-300">{title}</h3>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-white font-sans">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative py-24 md:py-32 px-4 text-center overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900">
              ...
              <SignedOut>
                <Link href="/sign-up">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group relative px-10 py-4 bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold rounded-2xl shadow-2xl transition-all duration-300 overflow-hidden"
                  >
                ...
                <Link href="#demo">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group flex items-center gap-3 px-8 py-4 text-white font-semibold border-2 border-gray-600 rounded-2xl hover:border-purple-500 transition-all duration-300 backdrop-blur-sm"
                  >
        ...
        <section className="py-16 px-4 bg-gray-900">
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-gray-800/50 to-gray-900/80 border border-gray-700/50 rounded-3xl shadow-2xl p-8 backdrop-blur-sm">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-600/10 to-pink-600/10 rounded-3xl"></div>
              <div className="relative z-10 aspect-video bg-gray-800/50 rounded-2xl border border-gray-700/50 flex items-center justify-center">
        ...
        {/* Features Section */}
        <section className="py-24 px-4 md:px-6 bg-gradient-to-br from-gray-900 via-purple-900/10 to-gray-900">
          <div className="container mx-auto">
